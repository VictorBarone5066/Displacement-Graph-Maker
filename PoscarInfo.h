...
extern double GENERAL_BOND_DISTANCE = 4.0; ///(angstroms) distance between any two atoms for them to be considered bonded (works well for POSCARS with only a few atom types)
...
class Poscar
{
	public:
		...
		std::vector <Coords> allPeriodicImages(std::string);
